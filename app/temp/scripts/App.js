...
//waypoint package, very popu;ar

var RevealOnScroll = function () {
	function RevealOnScroll(els, offset) {
		_classCallCheck(this, RevealOnScroll);

		this.itemsToReveal = (0, _jquery2.default)('.testimonials, .arrow');
		this.hideInitially();
		this.creatWaypoints();
	}
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.arrowLink = (0, _jquery2.default)('.arrow__link');
